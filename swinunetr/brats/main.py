...
parser.add_argument("--data_dir", default="/dataset/brats2020/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./jsons/brats20_folds.json", type=str, help="dataset json file")
