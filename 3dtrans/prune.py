...
# Assuming this is the import path for the 3D TransUNet model
...
if __name__ == "__main__":
    ...
    torch.save(pruned_model.state_dict(), "pruned_3d_transunet.pth")
    print("Pruning completed and the pruned model is saved to pruned_3d_transunet.pth")